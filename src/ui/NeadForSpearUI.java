...
public class NeadForSpearUI extends JFrame implements KeyListener, ObstacleListener, MouseListener, IPlayerListener,
		Serializable, IRewardListener, IMagicalAbilityListener {
	PhantasmUI paddleUI;
	private int time;
