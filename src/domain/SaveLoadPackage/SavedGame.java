...
public class SavedGame implements Serializable {
	...
	public SavedGame(double playerScore, int paddleExpansionCanceltime, int paddleXcoordinate, int playerChanceCount,
			...
			int[] playerAbilityCount, boolean[] chancesVisible, boolean[] abilityvisible, int doubleAccelCancelTime,
			int infVoidCancelTime, double violentAbilityCancelTime, int[] infiniteVoidIndexArray, double sphereDx,
			double sphereDy, int magicalHexCancelTime, int hexReleaseTime, ArrayList<MagicalHex> magicalHexList) {
